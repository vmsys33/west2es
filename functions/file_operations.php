...
function setFileTableVariables($table1, $file) {
    ...
    switch ($table1) {
        ...
        case 'aeld_files':
            ...
            break;
        case 'cild_files':
            $file_path = '/uploads/files/cild_files/' . basename($file['name']);
        ...
        case 'if_completed_files':
            $file_path = '/uploads/files/if_completed_files/' . basename($file['name']);
        ...
        case 'if_proposals_files':
            $file_path = '/uploads/files/if_proposals_files/' . basename($file['name']);
            ...
            break;
        case 'lulr_files':
            $file_path = '/uploads/files/lulr_files/' . basename($file['name']);
        ...
        case 'approved_proposal':
            $file_path = '/uploads/files/approved_proposal/' . basename($file['name']);
            $download_path = '../uploads/files/approved_proposal/' . basename($file['name']);
            $uploadDir = '../../uploads/files/approved_proposal/';
            $table2 = 'approved_proposal_versions';
            break;
        default:
