...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("SELECT file_path FROM rp_completed_nonberf_files_versions WHERE id = :revision_id");
        ...
        if (move_uploaded_file($file['tmp_name'], $filePath)) {
            ...
            $stmt = $pdo->prepare("UPDATE rp_completed_nonberf_files_versions 
