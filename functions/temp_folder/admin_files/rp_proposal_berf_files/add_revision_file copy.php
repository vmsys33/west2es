...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("SELECT name, MAX(version_no) AS latest_version FROM rp_proposal_berf_files_versions WHERE file_id = :file_id");
        ...
        if ($fileSizeInBytes < 1024) {
            ...
            // $stmt = $pdo->prepare("INSERT INTO rp_proposal_berf_files_versions (file_id, name, filename, file_path,download_path, version_no, file_size, datetime) 
