...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Check for duplicate filenames in if_proposals_files_versions table
        ...
        $stmt = $pdo->prepare("SELECT name, MAX(version_no) AS latest_version FROM if_proposals_files_versions WHERE file_id = :file_id");
