...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Check for duplicate filenames in aeld_files_versions table
        ...
        $stmt = $pdo->prepare("SELECT file_path FROM aeld_files_versions WHERE id = :revision_id");
        ...
        if (move_uploaded_file($file['tmp_name'], $filePath)) {
            ...
            $stmt = $pdo->prepare("UPDATE aeld_files_versions 
