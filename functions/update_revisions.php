...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!isset($_POST['revision_id'], $_POST['version_no'], $_POST['file_path'], $_POST['datetime'], $_POST['file_size'], $_POST['table2'])) {
    ...
    $table2 = filter_var($_POST['table2'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);

    try {
        // Prepare the SQL statement dynamically using the validated table name
