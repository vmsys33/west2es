            ...
            <li class="submenu-item py-2">
              <a href="pending-users.php" class="nav-link text-white <?= $currentPage == 'pending-users.php' ? 'active' : ''; ?>">
                ...
                <?php if ($pendingUsersCount > 0) { ?>
                  <span class="badge bg-danger ms-2"><?= $pendingUsersCount ?></span>
                <?php } ?>
              </a>
            </li>
              ...
              <a href="pending-files.php" class="nav-link text-white <?= $currentPage == 'pending-files.php' ? 'active' : ''; ?>">
                ...
                <?php if ($pendingFilesCount > 0) { ?>
                  <span class="badge bg-danger ms-2"><?= $pendingFilesCount ?></span>
                <?php } ?>
              </a>
            </li>      
             ...
             <li class="submenu-item py-2">
            <a href="notification.php" class="nav-link text-white <?= $currentPage == 'notification.php' ? 'active' : ''; ?>">
